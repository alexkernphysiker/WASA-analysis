...
ForwardDetectors::ForwardDetectors(){
	PlaneData.push_back(plane_data(kFWC1,0.0025,0.03,"FWC1"));
	PlaneData.push_back(plane_data(kFWC2,0.0025,0.03,"FWC2"));
	...
	PlaneData.push_back(plane_data(kFVH ,0.005 ,0.05,"FVH" ));
}
ForwardDetectors::~ForwardDetectors(){}
