...
int main(){
	...
	const hist<double> mc=Hist(MC,reaction[0],histpath_central_reconstr,string("GIMTDiff-Bin-")+to_string(bin_num)),
	mc2=Hist(MC,reaction[1],histpath_central_reconstr,string("GIMTDiff-Bin-")+to_string(bin_num)),
