...
int main()
{
    ...
    for (size_t bin_num = 0, bin_count = norm.size(); bin_num < bin_count; bin_num++) {
        ...
        const hist<> data_copl_mc2=
            ...
            .Scale(4).XRange(0,360);
        const auto data_copl_inside=data_copl.XRange(90,270);
        const auto data_copl_outside=data_copl.XExclude(90,270);
        cout << endl << Qmsg << endl;
        cout << endl;
