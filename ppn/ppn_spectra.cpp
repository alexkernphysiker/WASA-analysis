...
int main(){
    ...
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"pd",{"Histograms","elastic"},"t_vs_e_22"))
    <<"set zrange [0:]"<<"set title 'Cut1. MC pd'"<<"set xlabel "+th1<<"set ylabel "+e1;
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"ppn_qf",{"Histograms","elastic"},"t_vs_e_22"))
    <<"set zrange [0:]"<<"set title 'Cut1 MC ppn_{sp}'"<<"set xlabel "+th1<<"set ylabel "+e1;
    PlotHist2d<double>(sp2).Distr(Hist2d(DATA,"L",{"Histograms","elastic"},"t_vs_e_22"))
    <<"set zrange [0:]"<<"set title 'Cut1. Data "+runmsg+"'"<<"set xlabel "+th1<<"set ylabel "+e1;
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"pd",{"Histograms","elastic"},"e_vs_e_22"))
    <<"set zrange [0:]"<<"set title 'Cut1. MC pd'"<<"set xlabel "+e1<<"set ylabel "+e2;
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"ppn_qf",{"Histograms","elastic"},"e_vs_e_22"))
    ...
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"pd",{"Histograms","elastic"},"t_vs_t_32"))
    <<"set zrange [0:]"<<"set title 'Cut2. MC pd'"<<"set xlabel "+th1<<"set ylabel "+th2;
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"ppn_qf",{"Histograms","elastic"},"t_vs_t_32"))
    <<"set zrange [0:]"<<"set title 'Cut2. MC ppn_{sp}'"<<"set xlabel "+th1<<"set ylabel "+th2;
    PlotHist2d<double>(sp2).Distr(Hist2d(DATA,"L",{"Histograms","elastic"},"t_vs_t_32"))
    <<"set zrange [0:]"<<"set title 'Cut2. Data "+runmsg+"'"<<"set xlabel "+th1<<"set ylabel "+th2;
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"pd",{"Histograms","elastic"},"t_vs_e_32"))
    <<"set zrange [0:]"<<"set title 'Cut2. MC pd'"<<"set xlabel "+th1<<"set ylabel "+e1;
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"ppn_qf",{"Histograms","elastic"},"t_vs_e_32"))
    <<"set zrange [0:]"<<"set title 'Cut2. MC ppn_{sp}'"<<"set xlabel "+th1<<"set ylabel "+e1;
    PlotHist2d<double>(sp2).Distr(Hist2d(DATA,"L",{"Histograms","elastic"},"t_vs_e_32"))
    <<"set zrange [0:]"<<"set title 'Cut2. Data "+runmsg+"'"<<"set xlabel "+th1<<"set ylabel "+e1;
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"pd",{"Histograms","elastic"},"e_vs_e_32"))
    <<"set zrange [0:]"<<"set title 'Cut2. MC pd'"<<"set xlabel "+e1<<"set ylabel "+e2;
    PlotHist2d<double>(sp2).Distr(Hist2d(MC,"ppn_qf",{"Histograms","elastic"},"e_vs_e_32"))
    ...
    hist<double> acceptance,acceptance_pd;
	...
	const hist<double> mc_ppn=Hist(MC,"ppn_qf",{"Histograms","elastic"},string("theta_sum_32-Bin-")+to_string(bin_num));
	const hist<double> mc_pd=Hist(MC,"pd",{"Histograms","elastic"},string("theta_sum_32-Bin-")+to_string(bin_num));
	const hist<double> nmc_ppn=mc_ppn/(N*mc_ppn[0].X().uncertainty()*2.);
	const hist<double> nmc_pd=mc_pd/(N_pd*mc_pd[0].X().uncertainty()*2.);
	acceptance<<point<value<double>>(Q,mc_ppn.TotalSum()/N);
	acceptance_pd<<point<value<double>>(Q,mc_pd.TotalSum()/N_pd);
	const hist<double> data=Hist(DATA,"L",{"Histograms","elastic"},string("theta_sum_32-Bin-")+to_string(bin_num));

	Plot<double>().Hist(nmc_ppn,"ppn_{sp}").Hist(nmc_pd,"pd")
    ...
    Plot<double>().Hist(acceptance,"ppn_{sp}").Hist(acceptance_pd,"pd")<<"set key on"
